...
public class ServiceOrderApplicationService {
    ...
    public ServiceOrderResponse findById(Long id) {
        return ServiceOrderResponse.from(findEntity(id));
    }
    ...
    public ServiceOrderResponse create(CreateServiceOrderRequest request) {
        ...
        return ServiceOrderResponse.from(serviceOrders.save(order));
    }

    @Transactional
    public ServiceOrderResponse approve(Long id, String comment) {
    ...
    @Transactional
    public ServiceOrderResponse updateStatus(Long id, ServiceOrderStatus status, String comment) {
        var order = findEntity(id);
    ...
    @Transactional(readOnly = true)
    public PublicServiceOrderResponse findPublicByCode(String code, String document) {
        ...
        return PublicServiceOrderResponse.from(order);
    }

    @Transactional
    public PublicServiceOrderResponse approveByCustomer(String code, String document, String comment) {
        var normalizedDocument = DocumentValidator.normalize(document);
        var order = serviceOrders.findByCode(code)
